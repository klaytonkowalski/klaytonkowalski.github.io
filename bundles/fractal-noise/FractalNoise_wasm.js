...
var wasmBinaryFile = 'dmengine_release.wasm';
...
var ASM_CONSTS = {
  106980: function($0) {var jsResult; var isSuccess = 1; try { jsResult = eval(UTF8ToString($0)); } catch (err) { isSuccess = 0; jsResult = err; } _dmScript_Html5ReportOperationSuccess(isSuccess); jsResult += ''; var lengthBytes = lengthBytesUTF8(jsResult) + 1; var stringOnWasmHeap = _malloc(lengthBytes); stringToUTF8(jsResult, stringOnWasmHeap, lengthBytes); return stringOnWasmHeap;}
};
  ...
  var DefoldSoundDevice={TryResumeAudio:function() {
  ...
  var DMSYS={_folder:"/data",_cstr:null,GetUserPersistentDataRoot:function() {
                  if (typeof window !== 'undefined')
  ...
  var GLFW={keyFunc:null,charFunc:null,markedTextFunc:null,gamepadFunc:null,mouseButtonFunc:null,mousePosFunc:null,mouseWheelFunc:null,resizeFunc:null,closeFunc:null,refreshFunc:null,focusFunc:null,iconifyFunc:null,touchFunc:null,params:null,initTime:null,wheelPos:0,buttons:0,keys:0,initWindowWidth:640,initWindowHeight:480,windowX:0,windowY:0,windowWidth:0,windowHeight:0,prevWidth:0,prevHeight:0,prevNonFSWidth:0,prevNonFSHeight:0,isFullscreen:false,dpi:1,mouseTouchId:null,DOMToGLFWKeyCode:function(keycode) {
      ...
      },joys:{},lastGamepadState:null,lastGamepadStateFrame:null,refreshJoysticks:function(forceUpdate) {
...
var asmLibraryArg = {
  ...
  "clock": _clock,
  "difftime": _difftime,
  "dmDeviceJSFreeBufferSlots": _dmDeviceJSFreeBufferSlots,
  "dmDeviceJSOpen": _dmDeviceJSOpen,
  "dmDeviceJSQueue": _dmDeviceJSQueue,
  "dmGetDeviceSampleRate": _dmGetDeviceSampleRate,
  "dmScriptHttpRequestAsync": _dmScriptHttpRequestAsync,
  "dmSysGetApplicationPath": _dmSysGetApplicationPath,
  "dmSysGetUserAgent": _dmSysGetUserAgent,
  "dmSysGetUserPersistentDataRoot": _dmSysGetUserPersistentDataRoot,
  "dmSysGetUserPreferredLanguage": _dmSysGetUserPreferredLanguage,
  "dmSysOpenURL": _dmSysOpenURL,
  ...
  "glfwAccelerometerEnable": _glfwAccelerometerEnable,
  "glfwCloseWindow": _glfwCloseWindow,
  "glfwGetAcceleration": _glfwGetAcceleration,
  "glfwGetDefaultFramebuffer": _glfwGetDefaultFramebuffer,
  "glfwGetJoystickButtons": _glfwGetJoystickButtons,
  "glfwGetJoystickDeviceId": _glfwGetJoystickDeviceId,
  "glfwGetJoystickHats": _glfwGetJoystickHats,
  "glfwGetJoystickParam": _glfwGetJoystickParam,
  "glfwGetJoystickPos": _glfwGetJoystickPos,
  ...
  "glfwGetWindowRefreshRate": _glfwGetWindowRefreshRate,
  "glfwGetWindowSize": _glfwGetWindowSize,
  "glfwIconifyWindow": _glfwIconifyWindow,
  "glfwInitJS": _glfwInitJS,
  "glfwOpenWindow": _glfwOpenWindow,
  "glfwOpenWindowHint": _glfwOpenWindowHint,
  "glfwPollEvents": _glfwPollEvents,
  "glfwResetKeyboard": _glfwResetKeyboard,
  "glfwSetCharCallback": _glfwSetCharCallback,
  "glfwSetGamepadCallback": _glfwSetGamepadCallback,
  "glfwSetMarkedTextCallback": _glfwSetMarkedTextCallback,
  "glfwSetTouchCallback": _glfwSetTouchCallback,
  ...
  "glfwShowKeyboard": _glfwShowKeyboard,
...
/** @type {function(...*):?} */
var _dmExportedSymbols = Module["_dmExportedSymbols"] = createExportWrapper("dmExportedSymbols");
...
/** @type {function(...*):?} */
var _dmScript_Html5ReportOperationSuccess = Module["_dmScript_Html5ReportOperationSuccess"] = createExportWrapper("dmScript_Html5ReportOperationSuccess");
...
/** @type {function(...*):?} */
var _JSWriteDump = Module["_JSWriteDump"] = createExportWrapper("JSWriteDump");
...
if (!Object.getOwnPropertyDescriptor(Module, "DMSYS")) Module["DMSYS"] = function() { abort("'DMSYS' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "Script")) Module["Script"] = function() { abort("'Script' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
if (!Object.getOwnPropertyDescriptor(Module, "DefoldSoundDevice")) Module["DefoldSoundDevice"] = function() { abort("'DefoldSoundDevice' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
